...
If you have some coding abilities and would like to contribute to the actual codebase of Raidex then you can open a Pull Request(PR) against the repository.
...
In order for a Pull Request to get merged into the main repository you should have one approved review from one of the 
core developers of Raidex and also all Continuous Integration tests should be passing and the CI build should be
green.
