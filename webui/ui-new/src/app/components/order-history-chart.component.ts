...
@Component({
		...
		template: `
    		<div id="history_price"
				...
				[chartOptions] = "historyprice_ChartOptions"
				chartType="ScatterChart" GoogleChart>
				</div>
      	<div id="history_volume"
				[chartData]="historyvolume_ChartData"
				[chartOptions]= "historyvolume_ChartOptions"
