...
from rex.client import ClientService, CommitmentManager, OrderManager
...
def run(ctx, external_listen_address, **kwargs):
    ...
    commitment_manager = CommitmentManager(app_.raiden)
    # TODO: remove api from ClientService
    client = ClientService(app_.raiden, order_manager, commitment_manager, api=None)
    api = API(client)
    # TODO: run what now?
